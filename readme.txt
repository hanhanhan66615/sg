 ...
 **********************************************************************************************************
 * 实验简介
 * 实验名称：ATK-MC5640模块测试实验（JPEG）
 * 实验平台：正点原子 探索者 F407开发板
 * 实验目的：学习ATK-MC5640模块的使用方法
 ...
 **********************************************************************************************************
 * 实验现象
 * 1 程序烧录后，自动完成ATK-MC5640模块及其相关软硬件的初始化，若初始化失败，则在串口调试助手上输出相关初始化失
     败信息，并且LED0闪烁。
 * 2 初始化成功后，程序自动获取ATK-MC5640输出的JPEG图像数据，并将其通过串口输出，配合上位机查看ATK-MC5640模块
     输出的JPEG图像。
