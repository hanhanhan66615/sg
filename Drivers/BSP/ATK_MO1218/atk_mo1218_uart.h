...
#define ATK_MO1218_UART_TX_GPIO_PIN             GPIO_PIN_9
#define ATK_MO1218_UART_TX_GPIO_AF              GPIO_AF7_USART1  
#define ATK_MO1218_UART_TX_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0) 

#define ATK_MO1218_UART_RX_GPIO_PORT            GPIOA
#define ATK_MO1218_UART_RX_GPIO_PIN             GPIO_PIN_10
#define ATK_MO1218_UART_RX_GPIO_AF              GPIO_AF7_USART1  
#define ATK_MO1218_UART_RX_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0) 

#define ATK_MO1218_UART_INTERFACE               USART1
#define ATK_MO1218_UART_IRQn                    USART1_IRQn
#define ATK_MO1218_UART_IRQHandler              USART1_IRQHandler
#define ATK_MO1218_UART_CLK_ENABLE()            do{ __HAL_RCC_USART1_CLK_ENABLE(); }while(0)
